...
public class operator {
	...
	public static void athrmetic( int a,int b){ //creat the new fucntion for arthemetic
	...
	public static void logical_opr(int a,int b) {// create fuction for logical_opr.
		//AND
